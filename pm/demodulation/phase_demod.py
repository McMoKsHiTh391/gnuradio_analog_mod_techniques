...
class dsbsc_modulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._mi_range = qtgui.Range(1, 20, 2, 20, 200)
        ...
        self._fm_range = qtgui.Range(50, 1000, 100, 1000, 200)
        ...
        self._fc_range = qtgui.Range(100, 2000, 100, 2000, 200)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(mi)
        self.blocks_integrate_xx_0 = blocks.integrate_ff(1, 1)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.blocks_add_const_vxx_0 = blocks.add_const_cc(1)
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, fm, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, fc, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, fc, 1, 0, 0)
        self.analog_pll_freqdet_cf_0 = analog.pll_freqdet_cf(0.2, 3.14, 0.1)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_pll_freqdet_cf_0, 0), (self.blocks_integrate_xx_0, 0))
        ...
        self.connect((self.blocks_integrate_xx_0, 0), (self.blocks_throttle2_0, 0))
