...
class fm_mod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fm_mod")
        ...
        self._fm_range = qtgui.Range(0, 5000, 100, 5000, 200)
        ...
        self._fc_range = qtgui.Range(1000, 25000, 100, 25000, 200)
        ...
        self._beta_range = qtgui.Range(-2, 4, 1, 4, 200)
        ...
        self.connect((self.analog_fm_demod_cf_0, 0), (self.qtgui_time_sink_x_0_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.analog_fm_demod_cf_0, 0))
        self.connect((self.blocks_throttle2_0_0, 0), (self.analog_phase_modulator_fc_0, 0))
...
def main(top_block_cls=fm_mod, options=None):
