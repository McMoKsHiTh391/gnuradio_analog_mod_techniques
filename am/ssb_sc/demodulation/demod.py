...
class ssb(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 500, 1, 0, 0)
        self.analog_sig_source_x_0_0_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 500, 1, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 100, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 500, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.blocks_complex_to_float_0_1, 0))
        self.connect((self.analog_sig_source_x_0_0_1, 0), (self.blocks_throttle2_1, 0))
        ...
        self.connect((self.blocks_complex_to_float_0_0, 0), (self.blocks_multiply_xx_0_0_0, 0))
        ...
        self.connect((self.blocks_complex_to_float_0_1, 1), (self.blocks_multiply_xx_0_0_0, 1))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_multiply_xx_0_0_1, 0))
        ...
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_throttle2_0_0, 0))
        ...
        self.connect((self.blocks_throttle2_0_0_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_throttle2_0_0_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_throttle2_1, 0), (self.hilbert_fc_0, 0))
        self.connect((self.blocks_throttle2_1, 0), (self.hilbert_fc_1, 0))
        self.connect((self.hilbert_fc_0, 0), (self.blocks_complex_to_float_0, 0))
        self.connect((self.hilbert_fc_1, 0), (self.blocks_complex_to_float_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.blocks_throttle2_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 200, 50, window.WIN_HAMMING, 6.76))
