...
import am_receiver_epy_block_0 as epy_block_0  # embedded python block
import sip
...
class am_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_range = qtgui.Range(50, 500, 50, 500, 200)
        ...
        self._fc_range = qtgui.Range(100, 1000, 50, 1000, 200)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.epy_block_0 = epy_block_0.blk(threshold=0.0, mode=1, coeff=0.15)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 800, 1200, 500, window.WIN_HAMMING, 6.76))
        self.blocks_throttle2_0.set_sample_rate(self.samp_rate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 500, 500, window.WIN_HAMMING, 6.76))
