...
class dsbsc_modulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_range = qtgui.Range(100, 1000, 100, 1000, 200)
        ...
        self._fc_range = qtgui.Range(1000, 100000, 1000, 100000, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 6000, 2000, window.WIN_HAMMING, 6.76))
