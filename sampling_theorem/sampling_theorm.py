...
class sam(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sam")
        ...
        self._freq_kHz_range = qtgui.Range(0, 1.5e3, 1, 20, 200)
        self._freq_kHz_win = qtgui.RangeWidget(self._freq_kHz_range, self.set_freq_kHz, "cosine frequency", "dial", float, QtCore.Qt.Horizontal)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_2_win, 7, 4, 2, 3)
        for r in range(7, 9):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 7):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_1_win, 1, 4, 2, 3)
        for r in range(1, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 7):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_2_win, 7, 1, 3, 1)
        for r in range(7, 10):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_2.set_frequency_range(0, (self.samp_rate*10))
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate)
        self.qtgui_time_sink_x_1.set_samp_rate(self.samp_rate*10)
        self.qtgui_time_sink_x_2.set_samp_rate(self.samp_rate*10)
...
def main(top_block_cls=sam, options=None):
